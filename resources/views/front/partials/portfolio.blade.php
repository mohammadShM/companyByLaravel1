                        ...
                        <div class="add-actions text-center">
                            <div class="project-dec">
                                <a class="venobox" data-gall="myGallery"
                                   href="{{asset("front/img/portfolio/1.jpg")}}">
                                    <h4>Business City</h4>
                ...
                <div class="single-awesome-project">
                    <div class="awesome-img">
                        ...
                        <div class="add-actions text-center">
                            <div class="project-dec">
                                <a class="venobox" data-gall="myGallery"
                                   href="{{asset("front/img/portfolio/2.jpg")}}">
                                    <h4>Blue Sea</h4>
                                    <span>Photosho</span>
                                </a>
                            </div>
                ...
                <div class="single-awesome-project">
                    <div class="awesome-img">
                        ...
                        <div class="add-actions text-center">
                            <div class="project-dec">
                                <a class="venobox" data-gall="myGallery"
                                   href="{{asset("front/img/portfolio/3.jpg")}}">
                ...
                <div class="single-awesome-project">
                    <div class="awesome-img">
                        ...
                        <div class="add-actions text-center">
                            <div class="project-dec">
                                <a class="venobox" data-gall="myGallery"
                                   href="{{asset("front/img/portfolio/4.jpg")}}">
                                    <h4>Creative Team</h4>
                                    <span>Web design</span>
                                </a>
                            </div>
                ...
                <div class="single-awesome-project">
                    <div class="awesome-img">
                        ...
                        <div class="add-actions text-center text-center">
                            <div class="project-dec">
                                <a class="venobox" data-gall="myGallery"
                                   href="{{asset("front/img/portfolio/5.jpg")}}">
                ...
                <div class="single-awesome-project">
                    <div class="awesome-img">
                        ...
                        <div class="add-actions text-center">
                            <div class="project-dec">
                                <a class="venobox" data-gall="myGallery"
                                   href="{{asset("front/img/portfolio/6.jpg")}}">
                                    <h4>Night Hill</h4>
                                    <span>Photoshop</span>
                                </a>
                            </div>

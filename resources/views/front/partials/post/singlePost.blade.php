        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <article class="blog-post-wrapper">
                <div class="post-thumbnail">
                    <img class="imgSingle" src="{{asset('images/post/'.$post->image)}}" alt="{{$post->alt}}"/>
                </div>
                <div class="post-information">
                    ...
                    <div class="entry-content">
                        <p style="line-height: 30px" class="text-justify">{{$post->body}}</p>
                        <blockquote>
                            <p style="line-height: 30px" class="text-center">{{$post->description}}</p>
                        </blockquote>
                        <p style="line-height: 30px" class="text-center">{{$post->keywords}}</p>
                        <p style="line-height: 30px" class="text-center">{{$post->title_web}}</p>
                    </div>
                </div>
            </article>
            <div class="clear"></div>

...
@section('content-me')
    <section class="row m-0">
        ...
        <section class="col-8 offset-2 mt-5 mb-5 p-4 main-section-for-me">
            ...
            <section class="form-group">
                {!! Form::label('caption', 'Caption :', ['class' => 'text-white label-form-for-me']) !!}
                {!! Form::text('caption',old('caption'), ['class' => 'form-control text-form-for-me'
            ...
            <section class="form-group">
                ...
                <p class="text-left mt-4"><img src="{{asset('images/slider/'.$slider->image)}}" alt=""
            ...
            <a class="btn btn-info text-white text-capitalize font-weight-bolder"
               href="{{route('slider.index')}}">go to panel index slider</a>
        </section>
    </section>
@endsection
@section('css-me')
